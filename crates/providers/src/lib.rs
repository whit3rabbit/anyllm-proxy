...
pub use registry::{
    ...
    list_models, model_requires_anthropic_adaptive_thinking,
    model_supports_anthropic_adaptive_thinking, model_supports_anthropic_reasoning_effort,
    requires_numeric_tool_call_ids, resolve_backend, PROVIDERS_REQUIRING_NUMERIC_TOOL_CALL_IDS,
};
